...
export default function BookCalculator({ config, onSuccess = () => {}, onError = () => {} }) {
  ...
  // Generate page options from 4 to 500 in steps of 4
  const pageOptions = Array.from({ length: 125 }, (_, i) => {
    const pages = (i + 1) * 4;
    return {
  ...
  const multiPageOptions = [
    ...
    { value: "120", label: "120 Pages" },
    { value: "140", label: "140 Pages" },
    { value: "160", label: "160 Pages" },
    { value: "180", label: "180 Pages" },
    { value: "200", label: "200 Pages" },
    { value: "240", label: "240 Pages" },
    { value: "280", label: "280 Pages" },
    { value: "320", label: "320 Pages" },
    { value: "360", label: "360 Pages" },
    { value: "400", label: "400 Pages" },
    { value: "440", label: "440 Pages" },
    { value: "480", label: "480 Pages" },
