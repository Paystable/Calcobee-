...
export default function FlyerCalculator({ config, onSuccess = () => {}, onError = () => {} }) {
  ...
  useEffect(() => {
    if (selectedSize === "A2") {
      ...
      setLaminationSide("single");
      setSpotUVSide("single");
    }
  }, [selectedSize]);
                  ...
                  <FormControl fullWidth>
                    ...
                    {selectedSize === "A2" && (
                      <Typography variant="caption" color="text.secondary" sx={{ mt: 1, display: "block" }}>
                        Double-sided printing is not available for A2 size as it requires a separate plate
                      </Typography>
                    )}
                  </FormControl>
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      disabled={!isLamination || selectedSize === "A2"}
                      sx={{ 
                        cursor: (!isLamination || selectedSize === "A2") ? "not-allowed" : "pointer",
                        borderRadius: "12px",
                        "& .MuiOutlinedInput-notchedOutline": {
                          borderColor: "rgba(0, 0, 0, 0.1)",
                        },
                    ...
                    {selectedSize === "A2" && isLamination && (
                      <Typography variant="caption" color="text.secondary" sx={{ mt: 1, display: "block" }}>
                        Double-sided lamination is not available for A2 size
                      </Typography>
                    )}
                  </FormControl>
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      label="Spot UV Side"
                      disabled={!spotUV || selectedSize === "A2"}
                      sx={{ 
                        cursor: (!spotUV || selectedSize === "A2") ? "not-allowed" : "pointer",
                        borderRadius: "12px",
                        "& .MuiOutlinedInput-notchedOutline": {
                          borderColor: "rgba(0, 0, 0, 0.1)",
                        },
                    ...
                    {selectedSize === "A2" && spotUV && (
                      <Typography variant="caption" color="text.secondary" sx={{ mt: 1, display: "block" }}>
                        Double-sided spot UV is not available for A2 size
                      </Typography>
                    )}
                  </FormControl>
                </Grid>
